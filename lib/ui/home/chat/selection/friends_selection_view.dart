import 'package:chatApp/domain/models/chat_user.dart';
import 'package:chatApp/navigator_utils.dart';
import 'package:chatApp/ui/home/chat/chat_view.dart';
import 'package:chatApp/ui/home/chat/selection/friends_selection_cubit.dart';
import 'package:chatApp/ui/home/chat/selection/group_selection_view.dart';
        ...
        builder: (context, isGroup) {
          return BlocBuilder<FriendsSelectionCubit, List<ChatUserState>>(
            builder: (context, snapshot) {
              final selectedUsers =
                  context.read<FriendsSelectionCubit>().selectedUser;
